...
export default function Homepage() {
    ...
    function handleSearch(event) {
        ...
        setSearchResults(listings.filter((listing) => listing.title.toLowerCase().includes(searchTerm.toLowerCase())));
        ...
        <div className="bg-myColor-3">
            ...
            <motion.div
                ...
                {Auth.loggedIn() ? (
                    ...
                    <div>
                        <h1 className="overflow-y-auto h-[80vh]">
...
>>>>>>> b424fc452db2976b5ddd3c218be8f62a40ddbf83
}

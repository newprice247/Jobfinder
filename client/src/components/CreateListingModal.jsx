        ...
        <>
            ...
            <Card className="mx-auto w-full w-full">
                    <CardBody className="flex flex-col gap-4">
                        ...
                        <Input label="Title" id="title" size="lg" onChange={(event) => {
                        ...
                        <Input label="Description" id="description" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Location" id="location" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Salary" id="salary" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Benefits" id="benefits" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Company Name" id="company" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Company Website" id="website" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
                        <Typography className="-mb-2" variant="h6">
                        ...
                        <Input label="Requirements" id="requirements" size="lg" onChange={(event) => {
                            const { id, value } = event.target;
                            setNewJobListing({ ...newJobListing, [id]: value });
                        }} />
